...
const TITLE_BACKGROUND_PATH = fileURLToPath(new URL(
    '../script/module/scene/title/_title_background.js',
    import.meta.url
));
const AI_CONTEXT_PATH = fileURLToPath(new URL(
    '../script/module/scene/title/background/_title_background_ai_context.js',
    import.meta.url
));
const SIMULATION_RUNTIME_PATH = fileURLToPath(new URL(
    '../script/module/simulation/simulation_runtime.js',
    import.meta.url
));
