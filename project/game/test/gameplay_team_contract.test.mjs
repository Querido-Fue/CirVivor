...
function createProjectileIntent(overrides = {}) {
    return {
        ...
        schemaVersion: 1,
        archetypeId: 'team-contract-projectile',
        wordTagMask: 0,
        modifierSetId: null,
        sourceExecutionId: null,
        projectileGeneration: 1,
        originProducerId: 'team-contract-producer',
        originSourceAbilityId: 'team-contract-ability',
        originOwnerEntityId: 41,
        originOwnerIncarnation: 3,
        originSourceEntityId: 41,
