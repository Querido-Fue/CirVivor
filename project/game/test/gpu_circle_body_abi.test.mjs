...
assert.equal(GPU_CIRCLE_BODY_ABI.ENEMY_BEHAVIOR_STATE.CHARGE_ACCELERATION, 80);
assert.equal(GPU_CIRCLE_BODY_ABI.ENEMY_BEHAVIOR_STATE.RESERVED_0, 84);
assert.equal(GPU_CIRCLE_BODY_ABI.ENEMY_BEHAVIOR_STATE.RESERVED_1, 88);
assert.equal(GPU_CIRCLE_BODY_ABI.ENEMY_BEHAVIOR_STATE.RESERVED_2, 92);
...
assert.deepEqual({
    ...
    windupRangeTiles: 0,
    chargeAccelerationTilesPerSecondSquared: 0,
