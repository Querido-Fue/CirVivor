...
const routeShaderUrl = new URL(
    '../script/module/ingame/physics/gpu/gpu_atomic_transform_runtime_shaders.js',
    import.meta.url
);
const formationShaderUrl = new URL(
    '../script/module/ingame/physics/gpu/gpu_formation_runtime_shaders.js',
    import.meta.url
);
const routeRuntimeShaderUrl = new URL(
    '../script/module/ingame/physics/gpu/gpu_route_runtime_shaders.js',
    import.meta.url
);
