/** 타이틀 로고의 코드 소유 SVG 경로와 재생 순서입니다. */
...
const TITLE_LOGO_GROUPS = Object.freeze(
    TITLE_LOGO_SEQUENCE.map((sequence) => Object.freeze({
        ...
        bottomPaths: sequence.bottomKey
            ? (TITLE_LOGO_PATHS.bottom[sequence.bottomKey] || Object.freeze([]))
            : Object.freeze([])
    }))
);
...
export const TITLE_LOGO_ASSET = Object.freeze({
