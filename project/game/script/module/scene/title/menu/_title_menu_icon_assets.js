...
export const TITLE_MENU_ICON_TEMPLATES = Object.freeze({
  ...
  <defs>
    ...
    <radialGradient id="shadowGradient" cx="45%" cy="50%" r="55%">
      <stop offset="30%" stop-color="${TITLE_MENU_ICON_COLOR_TOKENS.SHADOW}" stop-opacity="0.6"/>
      <stop offset="100%" stop-color="${TITLE_MENU_ICON_COLOR_TOKENS.SHADOW}" stop-opacity="0"/>
    </radialGradient>
  </defs>

  <path d="M 114.4 37.7 L 61.5 5.4 C 52.6 0 41.6 6.9 41.6 17.7 V 82.3 C 41.6 93.1 52.6 99.9 61.5 94.6 L 114.4 62.3 C 123.3 56.8 123.3 43.2 114.4 37.7 Z" fill="${TITLE_MENU_ICON_COLOR_TOKENS.FILL}"/>

  <g clip-path="url(#backTriangleClip)">
    <rect x="0" y="0" width="100" height="100" fill="url(#shadowGradient)"/>
  </g>

  <path d="M 72.8 37.7 L 19.9 5.4 C 11 0 0 6.9 0 17.7 V 82.3 C 0 93.1 11 99.9 19.9 94.6 L 72.8 62.3 C 81.7 56.8 81.7 43.2 72.8 37.7 Z" fill="${TITLE_MENU_ICON_COLOR_TOKENS.FILL}"/>
</svg>`,
    records: `<svg width="1007" height="876" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" overflow="hidden"><defs><clipPath id="clip0"><rect x="2574" y="362" width="1007" height="876"/></clipPath></defs><g clip-path="url(#clip0)" transform="translate(-2574 -362)"><path d="M2574 421C2574 388.415 2600.42 362 2633 362L3047 362C3079.59 362 3106 388.415 3106 421L3106 421C3106 453.585 3079.58 480 3047 480L2633 480C2600.42 480 2574 453.585 2574 421Z" fill="${TITLE_MENU_ICON_COLOR_TOKENS.FILL}" fill-rule="evenodd"/><path d="M2574 800.001C2574 767.416 2600.42 741 2633 741L3522 741C3554.59 741 3581 767.416 3581 800.001L3581 800.001C3581 832.586 3554.58 859.001 3522 859.001L2633 859C2600.42 859 2574 832.585 2574 800Z" fill="${TITLE_MENU_ICON_COLOR_TOKENS.FILL}" fill-rule="evenodd"/><path d="M2574 1179C2574 1146.42 2600.42 1120 2633 1120L3225 1120C3257.58 1120 3284 1146.42 3284 1179L3284 1179C3284 1211.58 3257.58 1238 3225 1238L2633 1238C2600.42 1238 2574 1211.58 2574 1179Z" fill="${TITLE_MENU_ICON_COLOR_TOKENS.FILL}" fill-rule="evenodd"/></g></svg>`,
