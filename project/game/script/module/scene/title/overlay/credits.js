...
export class CreditsOverlay extends TitleOverlay {
    ...
    _generateLayout() {
        ...
        // 소제목 - 제작
        handler.newItemGroup().justifyContent("space_between", "WW", 1).width("parent", 96).align("center")
        ...
        // 제작자
        handler.newItemGroup().justifyContent("space_between", "WW", 1).width("parent", 90).align("center")
            ...
            .groupItem("horMargin").value("expand") // push space
