...
export const SENTENCE_COMPILE_ERROR_CODE = Object.freeze({
    ...
    DUPLICATE_MODIFIER_INSTANCE: 'DUPLICATE_MODIFIER_INSTANCE',
    MODIFIER_STACK_LIMIT_EXCEEDED: 'MODIFIER_STACK_LIMIT_EXCEEDED',
    MODIFIER_CONFLICT: 'MODIFIER_CONFLICT',
    UNSUPPORTED_MODIFIER_FOR_OPERATION: 'UNSUPPORTED_MODIFIER_FOR_OPERATION',
    UNSUPPORTED_MODIFIER: 'UNSUPPORTED_MODIFIER',
    MODIFIER_CARDINALITY_OVERFLOW: 'MODIFIER_CARDINALITY_OVERFLOW',
