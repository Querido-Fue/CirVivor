import { GpuCirclePipelineSet } from './gpu_circle_pipeline_set.js';
import { COMPUTE_PIPELINE_PROFILE, REQUIRED_COMPUTE_STORAGE_BUFFERS_PER_STAGE } from './gpu_circle_pipeline_profiles.js';
...
export class GpuCircleBodySimulation {
    ...
    #createGpuResources(device, format) {
        ...
        const pipelineSet = new GpuCirclePipelineSet(device, format, {
            buffers: this.buffers,
            flowTexture: this.flowTexture,
            flowIntegrationTexture: this.flowIntegrationTexture
        });
        this.pipelines = pipelineSet.pipelines;
        this.bindGroups = pipelineSet.bindGroups;
