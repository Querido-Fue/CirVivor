...
export const DENSE_REBUILD_DENSITY_THRESHOLD = 0.45;
export const DENSE_REBUILD_MIN_RESOLVED = 8;
const DENSE_REBUILD_MAX_EXTRA_PASSES = 4;
const DENSE_MIN_ITERATION_FLOOR = 5;
export const DENSE_LOCAL_CANDIDATE_THRESHOLD = 8;
const DENSE_STABILIZE_MAX_PASSES = 4;
const DENSE_STABILIZE_LIGHT_MAX_PASSES = 2;
export const DENSE_STABILIZE_MIN_RESOLVED = 4;
