...
const ENEMY_AI_QUALITY_PROFILES = ENEMY_AI_DATA.QUALITY_PROFILES;
const ENEMY_AI_STATE_TUNING = ENEMY_AI_DATA.STATE_TUNING;
const DEFAULT_ENEMY_AI_QUALITY_PROFILE = ENEMY_AI_DATA.DEFAULT_QUALITY_PROFILE;
const ENEMY_AI_STATE_SCHEMA_VERSION = 3;
const DEFAULT_ENEMY_AI_BASE_DESIRED_SPEED = ENEMY_AI_STATE_TUNING.BASE_DESIRED_SPEED_PX;
const DEFAULT_ENEMY_AI_CHARGE_COOLDOWN_BASE_SECONDS = ENEMY_AI_STATE_TUNING.CHARGE_COOLDOWN_BASE_SECONDS;
const DEFAULT_ENEMY_AI_CHARGE_COOLDOWN_ID_BUCKETS = ENEMY_AI_STATE_TUNING.CHARGE_COOLDOWN_ID_BUCKETS;
const DEFAULT_ENEMY_AI_CHARGE_COOLDOWN_BUCKET_SECONDS = ENEMY_AI_STATE_TUNING.CHARGE_COOLDOWN_BUCKET_SECONDS;
