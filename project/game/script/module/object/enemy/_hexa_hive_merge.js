...
const HEXA_HIVE_MERGE_CONTACT_SECONDS = HEXA_HIVE_MERGE_BALANCE.CONTACT_SECONDS;
...
const HEXA_HIVE_MERGE_PULL_DISTANCE_RATIO = 0.12;
const HEXA_HIVE_MERGE_MAX_PULL_HEIGHT_RATIO = 0.32;
const HEXA_HIVE_MERGE_PULL_SAFE_CELL_DISTANCE_RATIO = 0.94;
const HEXA_HIVE_MERGE_MIN_EFFECT_PROGRESS = 0;
const HEXA_HIVE_MERGE_MAX_EFFECT_COMMANDS = 8;
const HEXA_HIVE_MERGE_SETTLE_SECONDS = 0.18;
const HEXA_HIVE_MOVE_SPEED_DECAY = HEXA_HIVE_MERGE_BALANCE.MOVE_SPEED_DECAY;
const HEXA_HIVE_MOVE_SPEED_FLOOR_RATIO = HEXA_HIVE_MERGE_BALANCE.MOVE_SPEED_FLOOR_RATIO;
const HEXA_HIVE_WEIGHT_SCALE_PER_EXTRA_CELL = HEXA_HIVE_MERGE_BALANCE.WEIGHT_SCALE_PER_EXTRA_CELL;
const HEXA_HIVE_MERGE_PENDING_WEIGHT = HEXA_HIVE_MERGE_BALANCE.PENDING_WEIGHT;
const HEXA_HIVE_HP_RECOVERY_RATIO = HEXA_HIVE_MERGE_BALANCE.HP_RECOVERY_RATIO;
