...
import { ENEMY_MOTION_BALANCE } from 'data/object/enemy/enemy_balance_data.js';
import { getSimulationObjectWH } from 'simulation/simulation_runtime.js';
import { clamp01 } from 'util/number_util.js';

const FULL_TURN_DEG = 360;
const STRAIGHT_DEG = 180;
const MAX_ANGULAR_VELOCITY = ENEMY_MOTION_BALANCE.MAX_ANGULAR_VELOCITY;
const AXIS_RESISTANCE_RECOVERY_SECONDS = ENEMY_MOTION_BALANCE.AXIS_RESISTANCE_RECOVERY_SECONDS;
const AXIS_RESISTANCE_RECOVER_DELAY_SECONDS = ENEMY_MOTION_BALANCE.AXIS_RESISTANCE_RECOVER_DELAY_SECONDS;
const AXIS_RESISTANCE_EPSILON = 1e-4;
const ANGULAR_DECAY_MIN_SECONDS = ENEMY_MOTION_BALANCE.ANGULAR_DECAY_MIN_SECONDS;
