...
export class SettingsOverlay extends TitleOverlay {
    ...
    _buildLeftColumn(handler) {
        ...
        handler.width("parent", 58).groupItem("segment_control", "control_windowMode").width("parent", 100).height("WH", 3)
        ...
        handler.width("parent", 57).groupItem("slider", "control_renderScale").width("parent", 99)
        ...
        handler.width("parent", 57).groupItem("slider", "control_uiScale").width("parent", 99)
            .prop("trackHeight", this.WH * 0.008 * this.uiScale).prop("knobRadius", this.WH * 0.009 * this.uiScale)
        ...
        handler.width("parent", 57).groupItem("toggle", "control_disableTransparency").width("WW", 2.55).height("WH", 2)
        ...
        handler.width("parent", 57).groupItem("slider", "control_physicsFps").width("parent", 99)
            .prop("trackHeight", this.WH * 0.008 * this.uiScale).prop("knobRadius", this.WH * 0.009 * this.uiScale)
    ...
    _buildRightColumn(handler) {
        ...
        handler.width("parent", 58).groupItem("segment_control", "control_language").width("parent", 33.33 * getAvailableLanguages().length).height("WH", 3)
        ...
        handler.width("parent", 58).groupItem("segment_control", "control_darkMode").width("parent", 66.66).height("WH", 3)
        ...
        handler.width("parent", 57).groupItem("slider", "control_bgmVolume").width("parent", 99)
            .prop("trackHeight", this.WH * 0.008 * this.uiScale).prop("knobRadius", this.WH * 0.009 * this.uiScale)
        ...
        handler.width("parent", 57).groupItem("slider", "control_sfxVolume").width("parent", 99)
            .prop("trackHeight", this.WH * 0.008 * this.uiScale).prop("knobRadius", this.WH * 0.009 * this.uiScale)
        ...
        handler.width("parent", 57).groupItem("button", "control_keybindings").stylePreset("overlay_link_button")
