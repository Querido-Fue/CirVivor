...
/** Production key binding과 분리된 actual GameScene R7 modifier QA loadout입니다. */
export const R7_QA_SENTENCE_LOADOUT = Object.freeze({
    [ABILITY_SLOT_ID.SHIFT]: R7_TOWER_SHOOTS_TOWERS_TWICE_SENTENCE,
    [ABILITY_SLOT_ID.SPACE]: R7_TOWER_SHOOTS_ENEMIES_TWICE_SENTENCE,
    [ABILITY_SLOT_ID.Q]: R3_TOWER_SHOOTS_ENEMY_SENTENCE,
    [ABILITY_SLOT_ID.E]: R7_TOWER_SHOOTS_ENEMIES_TWICE_TWICE_SENTENCE
});
