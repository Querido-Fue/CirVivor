...
const [settingsSource, baseOverlaySource, titleMenuSource, loadingSceneSource, presentationSource, loadingSequenceSource, titleContentSource] = await Promise.all([
    readFile(new URL('../project/game/script/module/overlay/title/_settings_overlay.js', import.meta.url), 'utf8'),
    readFile(new URL('../project/game/script/module/overlay/_base_overlay.js', import.meta.url), 'utf8'),
    readFile(new URL('../project/game/script/module/scene/title/_title_menu.js', import.meta.url), 'utf8'),
    readFile(new URL('../project/game/script/module/scene/loading/_loading_scene.js', import.meta.url), 'utf8'),
    readFile(new URL('../project/game/script/module/scene/title/_title_scene_presentation.js', import.meta.url), 'utf8'),
    readFile(new URL('../project/game/script/module/scene/title/_title_loading_sequence.js', import.meta.url), 'utf8'),
    readFile(new URL('../project/game/script/module/scene/title/_title_scene_content.js', import.meta.url), 'utf8')
]);
