...
const [
    ...
    readSource('../project/game/script/module/display/webgl/_webgl_constants.js'),
    readSource('../project/game/script/module/overlay/_overlay_session.js'),
    readSource('../project/game/script/module/scene/title/menu/_title_menu_overlay_session.js'),
    readSource('../project/game/script/module/scene/title/menu/_title_menu_theme.js'),
    readSource('../project/game/script/module/scene/title/_title_menu.js'),
    readSource('../project/game/script/module/overlay/title/_title_overlay.js'),
    readSource('../project/game/script/module/overlay/title/_map_select_overlay.js'),
    readSource('../project/game/script/module/overlay/title/_settings_overlay.js'),
    readSource('../project/game/script/module/overlay/title/settings/_settings_state.js'),
    readSource('../project/game/script/data/settings/setting_definitions.js'),
    readSource('../project/game/script/module/save/_setting_handler.js'),
    readSource('../project/game/script/data/theme/light_theme.js')
]);
...
const baseOverlaySource = await readSource('../project/game/script/module/overlay/_base_overlay.js');
assert.match(
    baseOverlaySource,
