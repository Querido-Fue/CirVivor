...
} from '../project/game/script/module/ingame/physics/gpu/gpu_tower_target_query_abi.js';
import {
    GPU_TOWER_TARGET_QUERY_WGSL
} from '../project/game/script/module/ingame/physics/gpu/gpu_tower_target_query_shaders.js';
import {
    GpuTowerTargetQueryRuntime
} from '../project/game/script/module/ingame/physics/gpu/gpu_tower_target_query_runtime.js';
