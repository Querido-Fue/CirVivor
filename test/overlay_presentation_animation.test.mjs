...
const baseOverlaySource = await readFile(
    new URL('../project/game/script/module/overlay/_base_overlay.js', import.meta.url),
    'utf8'
);
...
const externalLinkOverlaySource = await readFile(
    new URL('../project/game/script/module/overlay/_external_link_warning_overlay.js', import.meta.url),
    'utf8'
);
assert.match(
...
const titleCardRegistrySource = await readFile(
    new URL('../project/game/script/module/scene/title/menu/_title_menu_card_registry.js', import.meta.url),
    'utf8'
);
