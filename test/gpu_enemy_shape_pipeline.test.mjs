...
const TITLE_WEBGPU_ENEMY_SHAPE_ATLAS_SOURCE = await readFile(
    new URL(
        '../project/game/script/module/scene/title/webgpu/_title_webgpu_enemy_shape_atlas.js',
        import.meta.url
    ),
    'utf8'
);
const ENEMY_SHAPE_ASSETS_SOURCE = await readFile(
    new URL('../project/game/script/module/object/enemy/_enemy_shape_assets.js', import.meta.url),
    'utf8'
);
