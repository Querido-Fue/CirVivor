...
const source = await readFile(new URL('../project/game/script/module/ui/element/_dropdown.js', import.meta.url), 'utf8');
const renderCalls = [];
const glassCalls = [];
...
const dependencies = new Map([
    ...
    ['display/webgl/_webgl_constants.js', createSyntheticModule(context, {
        OVERLAY_RENDER_CONSTANTS: { FLOATING_DROPDOWN_BLUR_RADIUS: 18 }
    })]
]);
