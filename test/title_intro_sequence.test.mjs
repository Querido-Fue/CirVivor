...
const sequenceSource = await readFile(
    new URL('../project/game/script/module/scene/title/_title_loading_sequence.js', import.meta.url),
    'utf8'
);
const titleSceneIntroSource = await readFile(
    new URL('../project/game/script/module/scene/title/_title_scene_intro_sequence.js', import.meta.url),
    'utf8'
);
...
const centerCircleSource = await readFile(
    new URL('../project/game/script/module/scene/title/_title_center_circle.js', import.meta.url),
    'utf8'
);
...
const circleEffectPassSource = await readFile(
    new URL('../project/game/script/module/display/webgl/_title_loading_circle_effect_pass.js', import.meta.url),
    'utf8'
);
assert.doesNotMatch(
...
for (const languageFile of ['korean.js', 'english.js']) {
    const languageSource = await readFile(
        new URL(`../project/game/script/data/localization/${languageFile}`, import.meta.url),
        'utf8'
    );
