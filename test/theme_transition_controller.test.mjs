...
const [source, displaySystemSource, colorUtilSource] = await Promise.all([
    readFile(new URL('../project/game/script/module/display/_theme_transition_controller.js', import.meta.url), 'utf8'),
    readFile(new URL('../project/game/script/module/display/display_system.js', import.meta.url), 'utf8'),
    readFile(new URL('../project/game/script/util/color_util.js', import.meta.url), 'utf8')
]);
