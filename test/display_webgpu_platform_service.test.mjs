...
const SERVICE_PATH = fileURLToPath(new URL(
    '../project/game/script/module/display/webgpu/webgpu_platform_service.js',
    import.meta.url
));
const INDEX_PATH = fileURLToPath(new URL('../project/game/index.html', import.meta.url));
const STYLE_PATH = fileURLToPath(new URL('../project/game/style.css', import.meta.url));
