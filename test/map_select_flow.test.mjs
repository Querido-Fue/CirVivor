...
const mapSelectOverlaySource = await readFile(
    new URL('../project/game/script/module/overlay/title/_map_select_overlay.js', import.meta.url),
    'utf8'
);
assert.match(
...
const titleSceneControllerSource = await readFile(
    new URL('../project/game/script/module/scene/title/_title_scene_controller.js', import.meta.url),
    'utf8'
);
assert.match(
