...
const PROJECT_DIRECTORY = path.resolve(SCRIPT_DIRECTORY, '..', '..', 'project');
...
const ROOT_NODE_TEST_FILES = Object.freeze(readdirSync(
    path.resolve(PROJECT_DIRECTORY, '..', 'test'),
    { withFileTypes: true }
).filter((entry) => entry.isFile() && entry.name.endsWith('.test.mjs'))
    .map((entry) => `../test/${entry.name}`)
    .sort());
export const R2_FINAL_FOCUSED_NODE_TEST_FILES = Object.freeze([
    '../test/enemy_core_impact_director.test.mjs',
    '../test/enemy_effect_contract_data.test.mjs',
    '../test/enemy_formation_contract_data.test.mjs',
    '../test/enemy_jorang_split_contract_data.test.mjs',
    '../test/enemy_jorang_split_spawn_boundary.test.mjs',
    '../test/enemy_octagon_directional_defense_contract_data.test.mjs',
    '../test/enemy_ring_projectile_capture_contract_data.test.mjs',
    '../test/game_object_route_availability_integration.test.mjs',
    '../test/gpu_circle_body_abi.test.mjs',
    '../test/gpu_enemy_cork_route_closure_contract.test.mjs',
    '../test/gpu_enemy_jorang_split_contract.test.mjs',
    '../test/gpu_enemy_octagon_directional_defense_contract.test.mjs',
    '../test/gpu_enemy_ring_projectile_capture_contract.test.mjs',
    '../test/gpu_enemy_shape_pipeline.test.mjs',
    '../test/ingame_core_terminal_outcome.test.mjs',
    '../test/ingame_enemy_lifecycle_command_owner.test.mjs',
    '../test/jorang_split_lineage_director.test.mjs',
    '../test/projectile_capture_director.test.mjs',
    '../test/projectile_capture_lifecycle.test.mjs',
    '../test/r2_enemy_showcase_content_data.test.mjs',
    '../test/r2_showcase_manual_launcher_contract.test.mjs',
    '../test/route_availability_host_contract.test.mjs',
    '../test/webgl_batch_lazy_state_binding.test.mjs'
]);
...
export const R2_FINAL_AUTOMATED_GATE_COMMANDS = Object.freeze([
    ...
    Object.freeze({
        ...
        executable: process.execPath,
        args: Object.freeze([
            '../test/support/run_r2_gpu_churn_soak.mjs',
            '--cycles=3'
        ])
    }),
    Object.freeze({
        ...
        executable: process.execPath,
        args: Object.freeze([
            '../test/support/build_enemy_ai_flow_field_wasm.mjs',
            '--check'
        ])
    }),
    Object.freeze({
        ...
        executable: process.execPath,
        args: Object.freeze([
            '../test/support/build_collision_contact_wasm.mjs',
            '--check'
        ])
    }),
    Object.freeze({
        ...
        args: Object.freeze([
            '--experimental-vm-modules',
            '../test/stress/enemy_ai_flow_field_stress.mjs'
        ])
    }),
    Object.freeze({
        ...
        executable: process.execPath,
        args: Object.freeze([
            '../test/support/run_nw_render_pipeline_golden.mjs',
            '--check'
        ])
    }),
    Object.freeze({
        ...
        executable: process.execPath,
        args: Object.freeze([
            '../test/support/run_nw_title_gpu_pipeline.mjs',
            '--profile',
            'smoke',
            '--pipeline-mode',
            'webgpu-kawase',
...
async function runHardwareFixtures() {
    ...
    for (const fixture of R2_FINAL_HARDWARE_FIXTURE_STAGES) {
        ...
        await runCommand(
            process.execPath,
            ['../test/support/run_nw_webgpu_capability.mjs'],
