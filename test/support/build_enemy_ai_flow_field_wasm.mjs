...
const wabtFactory = createRequire(new URL('../../project/package.json', import.meta.url))('wabt');

const WABT_VERSION = '1.0.39';
const WAT_PATH = fileURLToPath(new URL(
    '../../project/game/script/module/object/enemy/ai/wasm/_enemy_ai_flow_field.wat',
    import.meta.url
));
const OUTPUT_PATH = fileURLToPath(new URL(
    '../../project/game/script/module/object/enemy/ai/wasm/_enemy_ai_flow_field_wasm_bytes.js',
    import.meta.url
));
