...
const COMMAND_MODULE_URLS = Object.freeze({
    apply: new URL(
        '../project/game/script/module/scene/benchmark/commands/benchmark_scene_command_apply_handlers.js',
        import.meta.url
    ),
    builder: new URL(
        '../project/game/script/module/scene/benchmark/commands/benchmark_scene_command_builder.js',
        import.meta.url
    ),
    dispatcher: new URL(
        '../project/game/script/module/scene/benchmark/commands/benchmark_scene_command_dispatcher.js',
        import.meta.url
    ),
    protocol: new URL(
        '../project/game/script/module/scene/benchmark/commands/benchmark_scene_command_protocol.js',
        import.meta.url
    )
});
