import { createEnemyAIFlowFieldWasmRuntimeSync } from '../../project/game/script/module/object/enemy/ai/wasm/_enemy_ai_flow_field_wasm_runtime.js';

const statusElement = document.querySelector('#status');
const flowFieldStoreUrl = new URL(
    '../../project/game/script/module/object/enemy/ai/navigation/_enemy_ai_flow_field_store.js',
    import.meta.url
);
const backendUrl = new URL(
    '../../project/game/script/module/object/enemy/ai/wasm/_enemy_ai_flow_field_backend.js',
    import.meta.url
);
