...
test('R8 production scope와 actual acceptance entrypoint는 Wave/save/meta 확장을 만들지 않는다', async () => {
    ...
    assert.equal(
        ...
        'node ../test/support/run_nw_r8_shop_editor.mjs'
    );
    const productionFiles = [
        '../project/game/script/data/word/r8_word_shop_catalog_data.js',
        '../project/game/script/data/word/r8_word_upgrade_profile_data.js',
        '../project/game/script/module/ingame/contract/r8_fingerprint_contract.js',
        '../project/game/script/module/ingame/contract/sentence_board_contract.js',
        '../project/game/script/module/ingame/contract/shop_ui_command_contract.js',
        '../project/game/script/module/ingame/contract/word_inventory_contract.js',
        '../project/game/script/module/ingame/contract/word_shop_contract.js',
        '../project/game/script/module/ingame/contract/word_upgrade_contract.js',
        '../project/game/script/module/ingame/flow/shop_phase_coordinator.js',
        '../project/game/script/module/ingame/flow/shop_ui_command_executor.js',
        '../project/game/script/module/ingame/state/run_commerce_state.js',
        '../project/game/script/module/ingame/word/deterministic_shop_rng.js',
        '../project/game/script/module/ingame/word/runtime_word_catalog_view.js',
        '../project/game/script/module/ingame/word/sentence_board_state.js',
        '../project/game/script/module/ingame/word/word_inventory_state.js',
        '../project/game/script/module/ingame/word/word_shop_session.js'
    ];
