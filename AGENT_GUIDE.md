...
> **기준 코드**: 0.57 native global Debug overlay + display projection + settings/debug integration | **전환 상태**: NW.js read-only oracle + Windows C++20/SDL3 rewrite 병행 | **렌더링**: Canvas 2D + WebGL oracle, SDL_GPU/GLES/Software native 경로 병행
